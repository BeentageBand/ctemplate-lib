...
static std::set<int> SetCpp;
static union CSet_int CSetC = {NULL};
...
TEST_P(Test_CSetC, destroy)
{
  ...
  EXPECT_TRUE(NULL != found);
	...
	CSet_int_erase(&CSetC, GetParam().id); 
